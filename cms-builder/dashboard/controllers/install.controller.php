...
class InstallController{
	...
	/*=================================================
	=            TRAER LAS TABLAS DE LA DB            =
	=================================================*/
	
	/*se dispara en /tables/manage/blocks/forms/relations.php*/	
	static public function getTables(){

    /* Conexión a la base para obtener las tablas */        
    ...
    return []; // Retornar un array vacío si no hay tablas
}
