...
class AdminsController{
	...
	public function resetPassword(){
		...
		if(isset($_POST["resetPassword"])){
			...
			/*=============================================
			Preguntar primero si el usuario está registrado
			=============================================*/	
			...
			if($admin->status == 200){
				...
				if($updatePassword->status == 200){
					...
					$message = '<h4 style="font-weight: 100; color:#999; padding:0px 20px"><strong>Su nueva contraseña es: '.$newPassword.'</strong></4><h4 style="font-weight: 100; color:#999; padding:0px 20px">Ingrese nuevamente al sitio con esta contraseña y recuerde cambiarla</4>';
					...
					if($sendEmail == "ok"){
						...
						echo '<script>
								...
								fncFormatInputs();
								fncMatPreloader("off");
								fncSweetAlert("success", "Su nueva contraseña ha sido enviada con éxito, por favor revise su correo electrónico");
